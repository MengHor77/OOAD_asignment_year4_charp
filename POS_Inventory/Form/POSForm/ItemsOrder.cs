    ...
    public partial class ItemsOrder : UserControl
    {
        ...
        private void SetupOrderRowDesign()
        {
            ...
            btnPlus.Paint += (s, e) =>
            {
                ...
                {
                    gp.AddEllipse(0, 0, btnPlus.Width - 1, btnPlus.Height - 1);
                    btnPlus.Region = new Region(gp);
                }
            };
            ...
            btnMinus.Paint += (s, e) =>
            {
                using (System.Drawing.Drawing2D.GraphicsPath gp = new System.Drawing.Drawing2D.GraphicsPath())
                {
                    gp.AddEllipse(0, 0, btnMinus.Width - 1, btnMinus.Height - 1);
                    btnMinus.Region = new Region(gp);
                }
            };
            ...
            btnDelete.Paint += (s, e) =>
            {
                ...
                using (System.Drawing.Drawing2D.GraphicsPath gp = new System.Drawing.Drawing2D.GraphicsPath())
                {
                    gp.AddEllipse(0, 0, btnDelete.Width - 1, btnDelete.Height - 1);
                    btnDelete.Region = new Region(gp);
                }
            };
            btnDelete.Click += (s, e) =>
            {
